package com.sda.patterns.design.behavioral.memento.editor;

import com.sda.patterns.design.behavioral.memento.commands.ColorCommand;
import com.sda.patterns.design.behavioral.memento.commands.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter brush = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                com.sda.patterns.design.behavioral.memento.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
